...
namespace BrianSharp
{
    public class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            MainMenu = new Menu("Brian 原大师系列作者", "BrianSharp", true);
            var InfoMenu = new Menu("Info", "信息");
            {
                InfoMenu.AddItem(new MenuItem("Author", "作者: Brian  汉化者: Feeeez"));
            ...
            try
            {
                if (Activator.CreateInstance(null, "BrianSharp.脚本插件." + PlayerName) != null)
                {
                    ...
                    Helper.AddItem(MainMenu.SubMenu(PlayerName + "_Plugin").SubMenu("额外选项"), "UsePacket", "使用封包");
