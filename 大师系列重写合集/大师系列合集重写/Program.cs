...
namespace BrianSharp
{
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            MainMenu = new Menu("原大师合集", "BrianSharp", true);
            var InfoMenu = new Menu("Info", "汉化作者: Feeeez");
            {
                InfoMenu.AddItem(new MenuItem("Author", "脚本作者: Brian"));
                InfoMenu.AddItem(new MenuItem("Paypal", "贝宝: dcbrian01@gmail.com"));
